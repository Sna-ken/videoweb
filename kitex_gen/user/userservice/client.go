...
type Client interface {
	...
	UpdateSignature(ctx context.Context, req *user.UpdateSignatureReq, callOptions ...callopt.Option) (r *user.UpdateSignatureResp, err error)
...
func (p *kUserServiceClient) UpdateSignature(ctx context.Context, req *user.UpdateSignatureReq, callOptions ...callopt.Option) (r *user.UpdateSignatureResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateSignature(ctx, req)
}
